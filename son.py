...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 11; TECNO KD8)'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Crome'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4755.101 Mobile Safari/537.36'
	...
	ugen.append(uaku2)
for x in range(10):
	a='NokiaC2-01/5.0 (11.20) Profile/MIDP-2.1'
	...
	i='Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko)'
