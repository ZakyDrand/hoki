...
for xd in range(10000):
	a='Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaE52-1/052.003; Profile/MIDP-2.1 Configuration/CLDC-1.1 )'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='BrowserNG'
	e=random.randrange(100, 9999)
	f='AppleWebKit/525 (KHTML, like Gecko) Version/3.0 BrowserNG/7.2.6.2 3gpp-gba'
...
for x in range(10):
	...
	i='Chrome/95.0.4538.59 Mobile Safari/537.36'
