...
princp=[]
try:
	prox= requests.get('https://www.proxysite.com/v2/?request=displayproxies&protocol=socks4&timeout=100000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mAlvino_adijaya_xy')
prox=open('.prox.txt','r').read().splitlines()
for xd in range(10000):
	a='Mozilla/5.0 (Linux; U; Android 11; en-us; GT-S526N)'
	b=random.randrange(1, 11)
	c=random.randrange(1, 11)
	d='Chrome'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4482.72 MobileSafari/537.36'
...
for x in range(10):
	...
	i='Chrome/98.0.4755.101 Mobile Safari/537.36'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/tamimibrahim17/List-of-user-agents/blob/master/Chrome.txt').text
		ua=open('.Chrome.txt','w')
